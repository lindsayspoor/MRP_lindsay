import numpy as np
from plot_functions import plot_multiple_boxes_dynamic
...
moves_agent1=np.loadtxt(f"{folder}/moves_dynamic_ppo_board_size=3error_rate=0.01lr=annealingtotal_timesteps=3000000n_steps=2048mask_actions=Truefixed=Truec_reward=1e_reward=10l_reward=1N=1iteration_step=2ent_coef=0.05clip_range=0.1new_N=1_1.csv")
moves_agent2=np.loadtxt(f"{folder}/moves_dynamic_ppo_board_size=3error_rate=0.01lr=annealingtotal_timesteps=3000000n_steps=2048mask_actions=Truefixed=Truec_reward=1e_reward=10l_reward=1N=1iteration_step=3ent_coef=0.05clip_range=0.1new_N=1_1.csv")
moves_agent3=np.loadtxt(f"{folder}/moves_dynamic_ppo_board_size=3error_rate=0.01lr=annealingtotal_timesteps=3000000n_steps=2048mask_actions=Truefixed=Truec_reward=1e_reward=10l_reward=1N=2iteration_step=3ent_coef=0.05clip_range=0.1new_N=2_2.csv")
moves_agent4=np.loadtxt(f"{folder}/moves_dynamic_ppo_board_size=3error_rate=0.01lr=annealingtotal_timesteps=5000000n_steps=2048mask_actions=Truefixed=Truec_reward=1e_reward=10l_reward=1N=2iteration_step=4ent_coef=0.05clip_range=0.1new_N=2_2.csv")
...
path_plot = f"/Users/lindsayspoor/Library/Mobile Documents/com~apple~CloudDocs/Documents/Studiedocumenten/2023-2024/MSc Research Project/Results/Figure_results/Results_benchmarks/PPO_dymanic_boxes_different_settings.pdf"

plot_multiple_boxes_dynamic(path_plot, moves_random, moves_agent1, moves_agent2, moves_agent3, moves_agent4)